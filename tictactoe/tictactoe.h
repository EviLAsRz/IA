...
} tJugada;   // POR SIMPLIFICAR NO SE USARA AQUI, PERO ES NECESARIO EN OTROS JUEGOS

static int tablero_inicial[N] ={0,0,0, 0,0,0, 0,0,0};

// las posiciones seran numeradas de 0 a 8 de la siguiente forma:
//0 1 2
//3 4 5
//6 7 8
...
jugada: indica en que posicion del tablero pondre la marca
